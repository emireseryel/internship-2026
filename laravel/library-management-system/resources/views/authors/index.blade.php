...
<body class="bg-light">
    ...
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold text-secondary m-0">Authors Management</h2>
            <a href="{{ route('authors.create') }}" class="btn btn-primary shadow-sm">Add New Author
            </a>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-dark">
                        <tr>
                            <th scope="col" class="ps-4 py-3">Author</th>
                            <th scope="col" class="py-3">Number of Books</th>
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('authors.edit', $author->id) }}" class="btn btn-sm btn-outline-warning rounded-2 px-3"> Edit
                                    </a>

                                    <form action="{{ route('authors.destroy', $author->id) }}" method="POST" class="d-inline m-0">
                                        @csrf
                                        @method('DELETE')
